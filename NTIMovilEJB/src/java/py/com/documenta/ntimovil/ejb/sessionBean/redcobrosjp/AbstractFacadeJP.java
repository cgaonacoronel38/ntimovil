...
import py.com.documenta.ntimovil.ejb.sessionBean.movil.*;
 ...
 * @author tid
 */
public abstract class AbstractFacadeJP<T> {
    
    protected final Logger log = LoggerFactory.getLogger(AbstractFacadeJP.class);
    
    @PersistenceContext(unitName = "JPEJBPU")
    ...
    public AbstractFacadeJP(Class<T> entityClass) {
